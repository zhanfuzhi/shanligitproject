...
namespace Shanlitech_Location.Web.Module.Shanlitech_Location.T_VerificationRecordShenHe
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        private string SearchTerms
        {
            get
            {
                if (ViewState["SearchTerms"] == null)
                    ViewState["SearchTerms"] = string.Format(" Where state={0} and  TransferState={1}", (int)Status.Normal,(int)TransferState.ShenHe);
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            sb.AppendFormat("Where TransferState ={0}", (int)TransferState.ShenHe);
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName.Equals("Pass"))
            {
                ...
                if (entity != null)
                {
                    ...
                    entity.Checker = UserData.GetUserDate.UserID;
                    entity.CheckTime = (DateTime?)DateTime.Now;
                    BusinessFacadeShanlitech_Location.T_VerificationRecordInsertUpdateDelete(entity);
                    Page.ClientScript.RegisterStartupScript(this.GetType(), "alert1", "<script>alert('审核通过！');</script>");
                }
            }
            BindDataList();
        }
