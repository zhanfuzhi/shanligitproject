...
namespace Shanlitech_Location.Web.Module.Shanlitech_Location.UnicomBaseStation
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        private void BindDataList()
        {
            ...
            int RecordCount = 0;
            List<UnicomBaseStationEntity> lst = BusinessFacadeShanlitech_Location.UnicomBaseStationList(qp, out RecordCount);
    ...
    sb.AppendFormat(" AND locationDataID = {0} ", Convert.ToInt32(locationDataID_Value));
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < Checkbox_Value_Array.Length; i++)
            {
                ...
                {
                    UnicomBaseStationEntity et = new UnicomBaseStationEntity();
                    et.DataTable_Action_ = DataTable_Action.Delete;
                    et.ID = IDX;
                    BusinessFacadeShanlitech_Location.UnicomBaseStationInsertUpdateDelete(et);
                }
            }
