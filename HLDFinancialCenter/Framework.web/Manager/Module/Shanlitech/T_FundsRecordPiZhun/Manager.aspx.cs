...
namespace Shanlitech_Location.Web.Module.Shanlitech_Location.T_FundsRecordPiZhun
{
    public partial class Manager : System.Web.UI.Page
    {
        ...
        private void OnStart()
        {
            ...
            {
                case "New":
                    TabOptionItem1.Tab_Name = HeadMenuWebControls1.HeadOPTxt = "增加经费使用待批准单";
                    Hidden_Disp();
                    break;
                case "List":
                    TabOptionItem1.Tab_Name = HeadMenuWebControls1.HeadOPTxt = "查看经费使用待批准单";
                    Hidden_Input();
                    ButtonOption.Visible = false;
                    AddEditButton();
                    break;
                case "Edit":
                    TabOptionItem1.Tab_Name = HeadMenuWebControls1.HeadOPTxt = "修改经费使用待批准单";
                    Hidden_Disp();
                    AddDeleteButton();
                    break;
                case "Delete":
        ...
        private void OnStartData(T_FundsRecordEntity ut)
        {
            ...
            PiZhunState_Disp1.Text = ut.PiZhunState;
        }
        ...
        private void Hidden_Input()
        {
            ...
            PiZhunState_Input1.Visible = false;
        ...
        private void Hidden_Disp()
        {
            ...
            PiZhunState_Disp1.Visible = false;
        }
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string PiZhunState = (string)Common.sink(PiZhunState_Input1.UniqueID, MethodType.Post, 500, 0, DataType.Str);
            ...
            if (rInt > 0)
            {
                string OpTxt = string.Format("增加经费使用批准单成功!(ID:{0})", rInt);
                if (ut.DataTable_Action_ == DataTable_Action.Update)
                    OpTxt = string.Format("修改经费使用批准单成功!(ID:{0})", IDX);
