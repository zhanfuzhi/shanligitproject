...
namespace Shanlitech_Location.Web.Module.Shanlitech_Location.T_VerificationRecordCunDang
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        private string SearchTerms
        {
            get
            {
                if (ViewState["SearchTerms"] == null)
                    ViewState["SearchTerms"] = string.Format(" Where state={0} and  TransferState={1}", (int)Status.Normal,(int)TransferState.CunDang);
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            sb.AppendFormat(" Where TransferState ={0} ", (int)TransferState.CunDang);
