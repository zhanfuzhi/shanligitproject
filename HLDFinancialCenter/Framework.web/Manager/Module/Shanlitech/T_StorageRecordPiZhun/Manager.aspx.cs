...
namespace Shanlitech_Location.Web.Module.Shanlitech_Location.T_StorageRecordPiZhun
{
    public partial class Manager : System.Web.UI.Page
    {
        ...
        private void OnStart()
        {
            ...
            { 
                case "New":
                    TabOptionItem1.Tab_Name = HeadMenuWebControls1.HeadOPTxt = "增加待批准入库单";
                    Hidden_Disp();
                    break;
                case "List":
                    TabOptionItem1.Tab_Name = HeadMenuWebControls1.HeadOPTxt = "查看待批准入库单";
                    Hidden_Input();
                    //ButtonOption.Visible = false;
                    AddEditButton();
                    break;
                case "Edit":
                    TabOptionItem1.Tab_Name = HeadMenuWebControls1.HeadOPTxt = "修改待批准入库单";
                    Hidden_Disp();
                    AddDeleteButton();
                    break;
                case "Delete":
        ...
        private void OnStartData(T_StorageRecordEntity ut)
        {
            ...
            //StorageNumber_Input.Text = 
                StorageNumber_Disp.Text = ut.StorageNumber.ToString();
            //UnitPrice_Input.Text = 
                UnitPrice_Disp.Text = ut.UnitPrice.ToString();
            ...
            //Remark_Input.Text = 
                Remark_Disp.Text = ut.Remark.ToString();
            //CodeNO_Input.Text = 
