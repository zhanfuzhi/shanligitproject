...
namespace FrameWork.web.Module.FrameWork.GroupManager
{
    public partial class New : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            gt.Address = (string)Common.sink(Address_Input.UniqueID, MethodType.Post, 50, 0, DataType.Str);
            gt.CertificateNumber = (string)Common.sink(CertificateNumber_Input.UniqueID, MethodType.Post, 50, 0, DataType.Str);
            gt.EmailAddress = (string)Common.sink(EmailAddress_Input.UniqueID, MethodType.Post, 50, 0, DataType.Str);
            gt.Fax = (string)Common.sink(Fax_Input.UniqueID, MethodType.Post, 50, 0, DataType.Str);
            gt.Tel = (string)Common.sink(Tel_Input.UniqueID, MethodType.Post, 50, 0, DataType.Str);
            gt.ZipCode = (string)Common.sink(ZipCode_Input.UniqueID, MethodType.Post, 50, 0, DataType.Str);
            gt.Type=Convert.ToInt32(G_Type_DropDown.SelectedValue);
