    ...
    <FrameWorkWebControls:TabOptionWebControls ID="TabOptionWebControls1" runat="server">
		...
		<tr>
		    <td class="table_body table_body_NoWidth" style="height: 28px" >
                电子签名密码</td>
			<td class="table_none table_none_NoWidth" style="height: 28px" >
                <asp:TextBox ID="SignPassword" TextMode="Password" title="请输入密码~32:!" runat="server" CssClass="text_input"></asp:TextBox>
                <asp:Label ID="SignPassword_Value" runat="server" ></asp:Label></td>       
		    <td class="table_body table_body_NoWidth">
                    电子签名图片</td>
                <td class="table_none table_none_NoWidth">
                    <asp:Image ID="SignPicture" border=0 runat="server" class="SignPicture_img"/>
                    
                    <asp:FileUpload ID="FileUpload_SignPicture" runat="server" contentEditable="false" CssClass="text_input" />
               </td>
        ...
        <FrameWorkWebControls:TabOptionItem ID="TabOptionItem2" runat="server" Tab_Name="用户资料" Tab_Visible="False">
         <table width="100%" border="0" cellspacing="1" cellpadding="3" align="center">
            <tr>
                ...
                <td class="table_body table_body_NoWidth" rowspan="5">
                    照片</td>
                <td class="table_none table_none_NoWidth" rowspan="5">
            ...
            <tr>
                <td class="table_body table_body_NoWidth" >
                    姓名</td>
                <td class="table_none table_none_NoWidth" >
                    <asp:TextBox ID="U_CName" title="请输入姓名~20:" runat="server" CssClass="text_input"></asp:TextBox>
            ...
            <tr>
                ...
                <td class="table_body table_body_NoWidth" >
                    任职日期</td>
                <td class="table_none table_none_NoWidth" >
                    <asp:TextBox ID="U_WorkStartDate" title="请输入任职日期~:date" runat="server" CssClass="text_input" onfocus="javascript:HS_setDate(this);"></asp:TextBox>
