...
namespace Shanlitech_Location.Web.Module.Shanlitech_Location.T_StorageRecord
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        {
            string VeriID_Value = (string)Common.sink(VeriID_Input.UniqueID, MethodType.Post, 10, 0, DataType.Str);
            ...
            string StorageNumber_Value = (string)Common.sink(StorageNumber_Input.UniqueID, MethodType.Post, 10, 0, DataType.Str);
...
if (VeriID_Value != string.Empty)
{
    sb.AppendFormat(" AND VeriID = {0} ", Convert.ToInt32(VeriID_Value));
}
...
if (Model_Value != string.Empty)
{
    sb.AppendFormat(" AND Model like '%{0}%' ", Common.inSQL(Model_Value));
}
                    
if (StorageNumber_Value != string.Empty)
{
    sb.AppendFormat(" AND StorageNumber = {0} ", Convert.ToInt32(StorageNumber_Value));
}
    ...
    sb.AppendFormat(" AND CodeNO like '%{0}%' ", Common.inSQL(CodeNO_Value));
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < Checkbox_Value_Array.Length; i++)
            {
                ...
                {
                    T_StorageRecordEntity et = new T_StorageRecordEntity();
                    et.DataTable_Action_ = DataTable_Action.Delete;
                    et.ID = IDX;
                    BusinessFacadeShanlitech_Location.T_StorageRecordInsertUpdateDelete(et);
                }
            }
