<%@ Page Language="C#" MasterPageFile="~/Manager/MasterPage/PageTemplate.Master" AutoEventWireup="True"
    Codebehind="Default.aspx.cs" Inherits="Shanlitech_Location.Web.Module.Shanlitech_Location.T_VerificationRecordPiZhun.Default"
    Title="无标题页" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="server">
    ...
    <FrameWorkWebControls:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server"
         HeadOPTxt="核销申请待批准单列表" HeadTitleTxt="核销申请待批准单">
        <FrameWorkWebControls:HeadMenuButtonItem ButtonPopedom="New" ButtonUrl="Manager.aspx?CMD=New"
            ButtonUrlType="Href" ButtonVisible="false" ButtonName="核销申请待批准单" />
    </FrameWorkWebControls:HeadMenuWebControls>
    <FrameWorkWebControls:TabOptionWebControls ID="TabOptionWebControls1" runat="server">
        <FrameWorkWebControls:TabOptionItem ID="TabOptionItem1" runat="server" Tab_Name="核销申请待批准单列表">
            <asp:GridView ID="GridView1" runat="server" OnSorting="GridView1_Sorting" 
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderText="创建时间" SortExpression="CreateTime" DataField="CreateTime" />
                     <asp:TemplateField HeaderText="审核人" SortExpression="Checker">
                        <ItemTemplate>
                            <%# Shanlitech_Location.BusinessFacadeShanlitech_Location.GetUserNameByID((int)Eval("Checker"))%>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <%--<asp:BoundField HeaderText="实际支出" SortExpression="PayAmount" DataField="PayAmount" />--%>
<%--                           <asp:TemplateField HeaderText="其它操作">
                        <ItemTemplate>
                           <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Pass" CommandArgument='<%# Eval("ID") %>'
                                OnClientClick='javascript:return confirm("确定要通过吗？");' Text="批准通过">
                            </asp:LinkButton>
                              <asp:LinkButton ID="LinkButton2" runat="server" CommandName="NoPass" CommandArgument='<%# Eval("ID") %>'
                                OnClientClick='javascript:return confirm("确定要撤销审核吗？");' Text="撤销审核">
                            </asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>--%>
                </Columns>
