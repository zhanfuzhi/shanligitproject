...
{
    public partial class InStockManager : System.Web.UI.Page
    {
        Int32 IDX = (Int32)Common.sink("IDX", MethodType.Get, 10, 0, DataType.Int);
        Int32 VerID = (Int32)Common.sink("VerID", MethodType.Get, 10, 0, DataType.Int);
        ...
        private void AddEditButton()
        {
            ...
            bi.ButtonName = "入库表单";
            bi.ButtonUrl = string.Format("?CMD=Edit&IDX={0}&VerID={1}", IDX,VerID);
        ...
        private void AddDeleteButton()
        {
            ...
            bi.ButtonUrl = string.Format("DelData('?CMD=Delete&IDX={0}&VerID={1}')", IDX,VerID);
            HeadMenuWebControls1.ButtonList.Add(bi);
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            double PayAmount_Value = (double)UnitPrice_Value * StorageNumber_Value;
            ...
            if (rInt > 0)
            {
                ...
                if (ut.DataTable_Action_ == DataTable_Action.Insert)
                {
                    ...
                    logentity.DealType = (int)DealType.HXRK;
                ...
                EventMessage.MessageBox(1, "操作成功", OpTxt, Icon_Type.OK, Common.GetHomeBaseUrl(string.Format("Manager.aspx?IDX={0}&CMD=List",ut.VeriID)));
            }
            else if (rInt == -2)
            {
