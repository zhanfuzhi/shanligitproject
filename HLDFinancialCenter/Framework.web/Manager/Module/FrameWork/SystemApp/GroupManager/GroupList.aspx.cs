    ...
    public partial class GroupList : System.Web.UI.Page
    {
        ...
        private void OnStart()
        {
            ...
            if (GroupID == 0)
                ...
                sys_GroupTable gp=BusinessFacade.sys_GroupDisp(GroupID);
                CatNameTxt.Text = gp.G_CName;
                
                Address_Disp.Text = gp.Address;
                CertificateNumber_Disp.Text = gp.CertificateNumber;
                Fax_Disp.Text = gp.Fax;
                Tel_Disp.Text = gp.Tel;
                EmailAddress_Disp.Text = gp.EmailAddress;
                ZipCode_Disp.Text = gp.ZipCode;
                if (gp.Type == 1)
                {
                    G_Type_Txt.Text = "[实验室]";
                }
