...
namespace FrameWork.Components
{
    ...
    public class sys_UserTable
    {
        ...
        private String _SignPicture = ""; // SignPicture    数字签名，郭博浩2012-01-05
        private String _SignPassword = ""; // SignPassword 数字签名密码，郭博浩2012-01-05
        ...
        {
            set { this._SignPicture = value; }
            get { return this._SignPicture; }
        }
