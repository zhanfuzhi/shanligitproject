...
namespace Shanlitech_Location.Web.Module.Shanlitech_Location.T_ProjectBudget
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                sb.AppendFormat(" AND AnnualNO like '%{0}%' ", Common.inSQL(AnnualNO_Value.Trim()));
            }
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < Checkbox_Value_Array.Length; i++)
            {
                ...
                {
                    T_ProjectBudgetEntity et = BusinessFacadeShanlitech_Location.T_ProjectBudgetDisp(IDX);
