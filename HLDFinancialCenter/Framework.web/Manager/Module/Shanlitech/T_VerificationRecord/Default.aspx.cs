...
namespace Shanlitech_Location.Web.Module.Shanlitech_Location.T_VerificationRecord
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        {
            //存档
            if (e.CommandName.Equals("SubShenHe"))
            {
                ...
                if (entity != null)
                {
                    ...
                    Page.ClientScript.RegisterStartupScript(this.GetType(), "alert1", "<script>alert('提交审核成功！');</script>");
                }
            }
            BindDataList();
        }
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                int transfer = ((T_VerificationRecordEntity)e.Row.DataItem).TransferState;
