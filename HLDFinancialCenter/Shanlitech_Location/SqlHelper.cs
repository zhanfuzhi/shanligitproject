...
namespace Shanlitech_Location
{
    ...
    public abstract class SqlHelper
    {
        ...
        public static readonly string ConnectionStringLocalTransaction = ConfigurationManager.ConnectionStrings[ConfigurationManager.ConnectionStrings["DBType"].ToString()].ToString();
