...
namespace Shanlitech_Location.Web.Module.Shanlitech_Location.ProjectBudgetRadio
{
    public partial class SelectStock : System.Web.UI.Page
    {
        ...
        private void BindDataList()
        {
            ...
            int RecordCount = 0;
            List<T_StockEntity> lst = BusinessFacadeShanlitech_Location.T_StockList(qp, out RecordCount);
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string StockNumber_Value = (string)Common.sink(StockNumber_Input.UniqueID, MethodType.Post, 10, 0, DataType.Str);
...
if (StockNumber_Value != string.Empty)
{
    sb.AppendFormat(" AND StockNumber = {0} ", Convert.ToInt32(StockNumber_Value));
}
    ...
    sb.AppendFormat(" AND CodeNO like '%{0}%' ", Common.inSQL(CodeNO_Value));
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            if (Int32.TryParse(radio_Value, out IDX))
            {
                ...
                T_StockEntity entity = BusinessFacadeShanlitech_Location.T_StockDisp(IDX);
                string script = "<script>parent.hidePopWin(false);parent.ReloadPage(" + IDX + ",'" + entity.EquipmentName
                    + "','" + entity.Model+ "','" + entity.CodeNO + "');</script>";
