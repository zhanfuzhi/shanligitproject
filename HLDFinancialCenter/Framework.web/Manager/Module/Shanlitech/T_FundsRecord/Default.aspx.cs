...
namespace Shanlitech_Location.Web.Module.Shanlitech_Location.T_FundsRecord
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        private string SearchTerms
        {
            get
            {
                if (ViewState["SearchTerms"] == null)
                    ViewState["SearchTerms"] = string.Format(" Where state={0}",(int)Status.Normal);//经费使用申请单
        ...
        {
            //存档
            if (e.CommandName.Equals("SubShengQing"))
            {
                ...
                if (entity != null)
                {
                    ...
                    Page.ClientScript.RegisterStartupScript(this.GetType(), "alert1", "<script>alert('提交申请成功！');</script>");
                }
            }
            BindDataList();
        }
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                int transfer = ((T_FundsRecordEntity)e.Row.DataItem).TransferState;
