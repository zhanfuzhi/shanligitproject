<%@ Page Language="C#" MasterPageFile="~/Manager/MasterPage/PageTemplate.Master" AutoEventWireup="True"
    Codebehind="DefaultFunction.aspx.cs" Inherits="ShanliTech_HLD_Business.Web.Module.ShanliTech_HLD_Business.DeviceTemplate.DefaultFunction"
    Title="无标题页" %>
...
.td_input
{
    ...
    <FrameWorkWebControls:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server"  HeadHelpTxt="<a target='_blank' href='../../../Help/HelperDocument/DeviceDetectApp-InfoSecurity/DeviceFunctionTemplateHelp.aspx'>帮助</a>"
         HeadOPTxt="设备功能模板列表" HeadTitleTxt="设备功能模板">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="操作">
                        <ItemTemplate>
                            ...
                            <a href="DefaultPoint.aspx?FunctionID=<%#Eval("ID") %>">查看功能检定点模板</a>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
