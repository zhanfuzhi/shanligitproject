...
namespace ShanliTech_HLD_Business.Web.Module.ShanliTech_HLD_Business.DeviceTemplate
{
    public partial class Manager : System.Web.UI.Page
    {
        ...
        private void InitDropDown()
        {
            ...
            li.Text = "请选择设备检测方式";
            li.Value = "1"; //默认为自动检测方式
            this.DetectType_DropDown.Items.Add(li);
        ...
        {
            DeviceTemplateEntity ut = BusinessFacadeShanliTech_HLD_Business.DeviceTemplateDisp(IDX);
            OnStartData(ut);
            switch (CMD)
            { 
                case "New":
                    TabOptionItem1.Tab_Name = HeadMenuWebControls1.HeadOPTxt = "增加设备模板";
                    Hidden_Disp();
                    ...
                    break;
                case "List":
                    TabOptionItem1.Tab_Name = HeadMenuWebControls1.HeadOPTxt = "查看设备模板";
                    Hidden_Input();
                    ...
                    break;
                case "Edit":
                    TabOptionItem1.Tab_Name = HeadMenuWebControls1.HeadOPTxt = "修改设备模板";
                    Hidden_Disp();
                    AddDeleteButton();
                    HiddenByDetectType(ut.DetectTypeCode);
                    HiddenByDeviceCategory(ut.DeviceCategoryCode);
                    ...
                    break;
                case "Delete":
                    ToolMethods.TemplateFunctionAndPointDeleteByDeviceID(IDX);
                    ut.DataTable_Action_ = DataTable_Action.Update;
                    ut.DelFlag = true;
                    if (BusinessFacadeShanliTech_HLD_Business.DeviceTemplateInsertUpdateDelete(ut) > 0)
                    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string DetectMedium_Value = ((string)Common.sink(DetectMedium_Input.UniqueID, MethodType.Post, 50, 0, DataType.Str)).Trim();
            ...
            //ut.DeviceDepartmentID = DeviceDepartmentID_Value; //改为当前登录用户
            ...
            ut.DetectMedium = DetectMedium_Value;
            ...
            Int32 rInt = BusinessFacadeShanliTech_HLD_Business.DeviceTemplateInsertUpdateDelete(ut);
            if ( rInt> 0)
            {
                string OpTxt = string.Format("增加设备模板成功!(ID:{0})", rInt);
                if (ut.DataTable_Action_ == DataTable_Action.Update)
                    OpTxt = string.Format("修改设备模板成功!(ID:{0})", IDX);
