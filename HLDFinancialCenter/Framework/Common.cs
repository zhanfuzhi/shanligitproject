...
namespace FrameWork
{
    ...
    public class Common
    {
        ...
        /// <summary>
        /// 获取登陆用户UserCName,如果未登陆为:""
        /// </summary>
        public static string Get_UserCname 
        {
            get {
                if (Get_UserID > 0)
                {
                    sys_UserTable ut = BusinessFacade.sys_UserDisp(Get_UserID);
                    if (ut != null) { return ut.U_CName; } else { return ""; }
                }
                else { return ""; }
            }
        }
