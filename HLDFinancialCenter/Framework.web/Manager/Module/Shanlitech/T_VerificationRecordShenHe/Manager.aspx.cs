...
namespace Shanlitech_Location.Web.Module.Shanlitech_Location.T_VerificationRecordShenHe
{
    public partial class Manager : System.Web.UI.Page
    {
        ...
        private void OnStart()
        {
            ...
            { 
                case "New":
                    TabOptionItem1.Tab_Name = HeadMenuWebControls1.HeadOPTxt = "增加核销申请待审核单";
                    Hidden_Disp();
                    break;
                case "List":
                    TabOptionItem1.Tab_Name = HeadMenuWebControls1.HeadOPTxt = "查看核销申请待审核单";
                    Hidden_Input();
                    ButtonOption.Visible = false;
                    AddEditButton();
                    break;
                case "Edit":
                    TabOptionItem1.Tab_Name = HeadMenuWebControls1.HeadOPTxt = "修改核销申请待审核单";
                    Hidden_Disp();
                    AddDeleteButton();
                    break;
                case "Delete":
        ...
        {
            tr_CreateTime.Visible = false;
            tr_Undertaker.Visible = false;
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            int Checker=UserData.GetUserDate.UserID;
            ...
            if ( rInt> 0)
            {
                string OpTxt = string.Format("增加核销申请审核单成功!(ID:{0})", rInt);
                if (ut.DataTable_Action_ == DataTable_Action.Update)
                    OpTxt = string.Format("修改核销申请审核单成功!(ID:{0})",IDX);
