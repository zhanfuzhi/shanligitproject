        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="3" align="center">
            ...
            <tr>
                <td class="table_body">
                    原始签名密码</td>
                <td class="table_none">
                    <asp:TextBox ID="Old_SignPassword" TextMode="Password" title="请输入原始签名密码~20:" runat="server" CssClass="text_input"></asp:TextBox></td>
            </tr>
            <tr>
                <td class="table_body">
                    新签名密码</td>
                <td class="table_none">
                    <asp:TextBox ID="New_SignPassword" TextMode="Password" title="请输入新签名密码~20:" runat="server" CssClass="text_input"></asp:TextBox></td>
            </tr>
            <tr>
                <td class="table_body" nowrap>
                    重新输入新签名密码</td>
                <td class="table_none">
                    <asp:TextBox ID="ReNew_SignPassword" TextMode="Password" title="请重新输入新签名密码~20:" runat="server" CssClass="text_input"></asp:TextBox></td>
            </tr>
            <tr>
