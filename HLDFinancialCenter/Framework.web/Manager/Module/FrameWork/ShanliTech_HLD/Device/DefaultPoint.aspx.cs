...
namespace ShanliTech_HLD_Business.Web.Module.ShanliTech_HLD_Business.Device
{
    public partial class DefaultPoint : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Is_P_Cate = ToolMethods.IsPresureDevice(DeviceID,false);
            AddNewButton();
            ...
            if (!Page.IsPostBack)
            {
                if (!string.IsNullOrEmpty(CMD))
                {
                    ...
                    {
                        DetectPointEntity point = BusinessFacadeShanliTech_HLD_Business.DetectPointDisp(PointID);
                        switch (CMD)
                        {
                            case "Up":
        ...
        private void BindDataList()
        {
            ...
            qp.OrderType = 0;
            int RecordCount = 0;
            List<DetectPointEntity> lst = BusinessFacadeShanliTech_HLD_Business.DetectPointList(qp, out RecordCount);
        ...
        {
            //string CommandCode_Value = ((string)Common.sink(CommandCode_Input.UniqueID, MethodType.Post, 50, 0, DataType.Str)).Trim();
            ...
            sb.Append(" Where DelFlag = 0 And FunctionID = " + FunctionID);
