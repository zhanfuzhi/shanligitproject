...
namespace Shanlitech_Location.Web.Module.Shanlitech_Location.T_StockLog
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        private void BindDataList()
        {
            ...
            int RecordCount = 0;
            List<T_StockLogEntity> lst = BusinessFacadeShanlitech_Location.T_StockLogList(qp, out RecordCount);
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string DealType_Value = (string)Common.sink(DealType_Input.UniqueID, MethodType.Post, 10, 0, DataType.Str);
            string Number_Value = (string)Common.sink(Number_Input.UniqueID, MethodType.Post, 10, 0, DataType.Str);
            string Handler_Value = (string)Common.sink(Handler_Input.UniqueID, MethodType.Post, 10, 0, DataType.Str);
            string StorID_Value = (string)Common.sink(StorID_Input.UniqueID, MethodType.Post, 10, 0, DataType.Str);
            string OutbID_Value = (string)Common.sink(OutbID_Input.UniqueID, MethodType.Post, 10, 0, DataType.Str);
...
if (DealType_Value != string.Empty)
{
    sb.AppendFormat(" AND DealType = {0} ", Convert.ToInt32(DealType_Value));
}
                    
if (Number_Value != string.Empty)
{
    sb.AppendFormat(" AND Number = {0} ", Convert.ToInt32(Number_Value));
}
                    
if (Handler_Value != string.Empty)
{
    sb.AppendFormat(" AND Handler = {0} ", Convert.ToInt32(Handler_Value));
}
                    
if (StorID_Value != string.Empty)
{
    sb.AppendFormat(" AND StorID = {0} ", Convert.ToInt32(StorID_Value));
}
                    
if (OutbID_Value != string.Empty)
{
    sb.AppendFormat(" AND OutbID = {0} ", Convert.ToInt32(OutbID_Value));
}
