<%@ Page Language="C#" MasterPageFile="~/Manager/MasterPage/PageTemplate.Master" AutoEventWireup="true"
    Codebehind="Default.aspx.cs" Inherits="Shanlitech_Location.Web.Module.Shanlitech_Location.T_ProjectDic.Default"
    Title="无标题页" %>

<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="server">
    <FrameWorkWebControls:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server"
         HeadOPTxt="T_ProjectDic列表" HeadTitleTxt="T_ProjectDic">
    ...
    <FrameWorkWebControls:TabOptionWebControls ID="TabOptionWebControls1" runat="server">
        <FrameWorkWebControls:TabOptionItem ID="TabOptionItem1" runat="server" Tab_Name="T_ProjectDic列表">
            <asp:GridView ID="GridView1" runat="server" OnSorting="GridView1_Sorting" OnRowCreated="GridView1_RowCreated" >
                <Columns>
                    ...
                    <asp:BoundField HeaderText="ProjectName" SortExpression="ProjectName" DataField="ProjectName" />
                    ...
                    <asp:BoundField HeaderText="CreateTime" SortExpression="CreateTime" DataField="CreateTime" />
                    <asp:BoundField HeaderText="UpdateTime" SortExpression="UpdateTime" DataField="UpdateTime" />
                </Columns>
            </asp:GridView>
