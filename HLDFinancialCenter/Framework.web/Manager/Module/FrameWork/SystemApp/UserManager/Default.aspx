    ...
    <FrameWorkWebControls:TabOptionWebControls ID="TabOptionWebControls1" runat="server">
        <FrameWorkWebControls:TabOptionItem ID="TabOptionItem1" runat="server" Tab_Name="用户资料列表">
            <asp:GridView ID="GridView1" runat="server" OnSorting="GridView1_Sorting" OnRowCreated="GridView1_RowCreated">
                <Columns>
                    <asp:BoundField SortExpression="U_UserNO" HeaderText="人员编号" DataField="U_UserNO" />
                    ...
                    <asp:BoundField SortExpression="U_WorkStartDate" HeaderText="任职日期" DataField="U_WorkStartDate" DataFormatString="{0:yyyy/MM/dd}"
                        HtmlEncode="false" />
