<%@ Page Language="C#" MasterPageFile="~/Manager/MasterPage/PageTemplate.Master"
    AutoEventWireup="True" CodeBehind="ManagerPoint.aspx.cs" Inherits="ShanliTech_HLD_Business.Web.Module.ShanliTech_HLD_Business.DeviceTemplate.ManagerPoint"
    Title="无标题页" %>
...
<link rel="stylesheet" href="../../../Css/Site_Css.css" type="text/css" />
    ...
    <FrameWorkWebControls:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server"
        HeadHelpTxt="<a target='_blank' href='../../../Help/HelperDocument/DeviceDetectApp-InfoSecurity/FunctionPointTemplateHelp.aspx?#p5'>帮助</a>"
        HeadTitleTxt="功能检定点模板">
        <%--<FrameWorkWebControls:HeadMenuButtonItem ButtonPopedom="List" ButtonUrl="Default.aspx"
            ButtonUrlType="Href" ButtonVisible="True" ButtonName="测试点模板" />--%>
    </FrameWorkWebControls:HeadMenuWebControls>
    <FrameWorkWebControls:TabOptionWebControls ID="TabOptionWebControls1" runat="server">
        <FrameWorkWebControls:TabOptionItem ID="TabOptionItem1" runat="server" Tab_Name="查看/修改/增加功能检定点模板">
            <table width="100%" border="0" cellspacing="1" cellpadding="3" align="center">
                <tr>
                    ...
                    <td class="table_none">
                        ...
                        <%-- <asp:TextBox ID="FunctionID_Input" title="请输入设备功能模板编号~float" runat="server" CssClass="text_input" Enabled="false"></asp:TextBox>
