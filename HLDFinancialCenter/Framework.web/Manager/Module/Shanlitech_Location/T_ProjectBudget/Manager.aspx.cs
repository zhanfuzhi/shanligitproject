...
namespace Shanlitech_Location.Web.Module.Shanlitech_Location.T_ProjectBudget
{
    public partial class Manager : System.Web.UI.Page
    {
        ...
        DepartmentID_Input.Visible = false;
        ...
        DepartmentID_Disp.Visible = false;
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            int DepartmentID_Value = (int)Common.sink(DepartmentID_Input.UniqueID, MethodType.Post, 10, 0, DataType.Int);
            T_ProjectBudgetEntity ut = BusinessFacadeShanlitech_Location.T_ProjectBudgetDisp(IDX);
