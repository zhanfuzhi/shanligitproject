...
namespace FrameWork.web.Module.FrameWork.UserManager
{
    public partial class UserManager : System.Web.UI.Page
    {
        ...
        private void Hidden_Input()
        {
            ...
            SignPassword.Visible = false;
            FileUpload_SignPicture.Visible = false;
        }
        ...
        private void Hidden_Disp()
        {
            ...
            SignPassword_Value.Visible = false;
        }
        ...
        private void OnStartData(sys_UserTable ut)
        {
            ...
            SignPassword_Value.Text = "******";
            if (!(ut.SignPicture + "").Trim().Equals(""))
            {
                SignPicture.ImageUrl = Common.BuildDownFileUrl("SignPictures/" + ut.SignPicture);

            }
            else
            {
                SignPicture.Visible = false;
            }
            #endregion
            ...
            //else
            //    U_PhotoUrl_Value.Visible = false;
            SignPassword.Attributes["value"] = ut.SignPassword;
            #endregion
        }
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string U_EName_Txt = string.Empty;// (string)Common.sink(U_EName.UniqueID, MethodType.Post, 50, 0, DataType.Str);
            ...
            string U_CompanyMail_Txt = string.Empty;// (string)Common.sink(U_CompanyMail.UniqueID, MethodType.Post, 100, 0, DataType.Email);
            ...
            string SignPassword_Txt = (string)Common.sink(SignPassword.UniqueID, MethodType.Post, 32, 1, DataType.Str);
            ...
            if (CMD == "New")
            {
                ...
                ut.SignPassword = Common.md5(SignPassword_Txt, 32);
            ...
            else if (CMD == "Edit")
            {
                ...
                if (BusinessFacade.sys_UserCheckManager())
                {
                    ...
                    if (ut.UserID != 1)
                    {
                        ...
                        if (SignPassword_Txt != ut.SignPassword)
                        {
                            ut.SignPassword = Common.md5(SignPassword_Txt, 32);
                        }
                    }
            ...
            //电子签名图片
            string Get_SignPicture = UpSignPicture();
            if (!string.IsNullOrEmpty(Get_SignPicture))
            {
                ut.SignPicture = Get_SignPicture;
            }
