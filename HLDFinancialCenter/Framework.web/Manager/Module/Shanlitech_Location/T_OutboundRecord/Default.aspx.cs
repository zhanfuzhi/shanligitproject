...
namespace Shanlitech_Location.Web.Module.Shanlitech_Location.T_OutboundRecord
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string OutboundNumber_Value = (string)Common.sink(OutboundNumber_Input.UniqueID, MethodType.Post, 10, 0, DataType.Str);
            string BalanceNumber_Value = (string)Common.sink(BalanceNumber_Input.UniqueID, MethodType.Post, 10, 0, DataType.Str);
...
if (OutboundNumber_Value != string.Empty)
{
    sb.AppendFormat(" AND OutboundNumber = {0} ", Convert.ToInt32(OutboundNumber_Value));
}
                    
if (BalanceNumber_Value != string.Empty)
{
    sb.AppendFormat(" AND BalanceNumber = {0} ", Convert.ToInt32(BalanceNumber_Value));
}
