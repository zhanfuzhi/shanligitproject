            ...
            <asp:GridView ID="GridView1" runat="server" OnSorting="GridView1_Sorting" 
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderText="申请时间" SortExpression="AppricationTime" DataField="AppricationTime" />
                     <asp:TemplateField HeaderText="申请状态" SortExpression="TransferState">
                        <ItemTemplate>
                            <%# InnitList((int)Eval("TransferState"))%>
                        </ItemTemplate>
                    </asp:TemplateField>
                  <asp:TemplateField HeaderText="其它操作">
                        <ItemTemplate>
                           <asp:LinkButton ID="LinkButton1" runat="server" CommandName="SubShengQing" CommandArgument='<%# Eval("ID") %>'
                                OnClientClick='javascript:return confirm("确定要提交申请吗？");' Text="提交申请">
                            </asp:LinkButton>
                            <asp:Label ID="Label1" runat="server" Text="已提交" Visible="false"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                  </Columns>
            </asp:GridView>
