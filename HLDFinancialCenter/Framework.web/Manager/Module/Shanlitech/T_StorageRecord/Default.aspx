...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="server">
    ...
    <FrameWorkWebControls:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server"
         HeadOPTxt="入库申请单列表" HeadTitleTxt="入库申请单">
        <FrameWorkWebControls:HeadMenuButtonItem ButtonPopedom="New" ButtonUrl="Manager.aspx?CMD=New"
            ButtonUrlType="Href" ButtonVisible="True" ButtonName="入库申请单" />
    </FrameWorkWebControls:HeadMenuWebControls>
    <FrameWorkWebControls:TabOptionWebControls ID="TabOptionWebControls1" runat="server">
        <FrameWorkWebControls:TabOptionItem ID="TabOptionItem1" runat="server" Tab_Name="入库申请单列表">
            <asp:GridView ID="GridView1" runat="server" OnSorting="GridView1_Sorting" OnRowCreated="GridView1_RowCreated" >
                <Columns>
                  ...
                  <%--   <asp:TemplateField HeaderText="申请人" SortExpression="Applicant">
                      ...
                      <asp:TemplateField HeaderText="申请状态" SortExpression="Approver">
                        <ItemTemplate>
                            <%# InnitList((int)Eval("Approver"))%>
                        </ItemTemplate>
                    </asp:TemplateField>
