<%@ Page Language="C#" MasterPageFile="~/Manager/MasterPage/PageTemplate.Master" AutoEventWireup="True"
    Codebehind="DefaultCheck.aspx.cs" Inherits="ShanliTech_HLD_Business.Web.Module.ShanliTech_HLD_Business.DeviceDetect.DefaultCheck"
    Title="无标题页" %>
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="操作">
                        <ItemTemplate>
                            ...
                            <%--<a href="Doc_Online_Check.aspx?ReportPath=<%#Eval("ReportPath") %>">查看证书</a>--%>
                        </ItemTemplate>
                    </asp:TemplateField>
