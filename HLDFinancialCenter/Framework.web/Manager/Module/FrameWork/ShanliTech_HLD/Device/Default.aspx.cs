...
namespace ShanliTech_HLD_Business.Web.Module.ShanliTech_HLD_Business.Device
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        private void BindDataList()
        {
            ...
            int RecordCount = 0;
            List<DeviceEntity> lst = BusinessFacadeShanliTech_HLD_Business.DeviceList(qp, out RecordCount);
        ...
        private string SearchTerms
        {
            get
            {
                ...
                //含子部门
                //string.Format(" Where DelFlag = 0 And DeviceDepartmentID = {0}", UserData.GetUserDate.U_GroupID);
                // string.Format(" Where DelFlag = 0 And DeviceDepartmentID in (select GroupID from getAllChild({0}))", UserData.GetUserDate.U_GroupID);
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < Checkbox_Value_Array.Length; i++)
            {
                if (Int32.TryParse(Checkbox_Value_Array[i], out IDX))
                {
                    ...
                    DeviceEntity et = BusinessFacadeShanliTech_HLD_Business.DeviceDisp(IDX);
                    et.DataTable_Action_ = DataTable_Action.Update;
                    et.DelFlag = true;
                    BusinessFacadeShanliTech_HLD_Business.DeviceInsertUpdateDelete(et);
                }
            }
