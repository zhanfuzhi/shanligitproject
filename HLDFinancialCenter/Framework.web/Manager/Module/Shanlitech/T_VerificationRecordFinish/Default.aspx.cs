...
namespace Shanlitech_Location.Web.Module.Shanlitech_Location.T_VerificationRecordFinish
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        private string SearchTerms
        {
            get
            {
                if (ViewState["SearchTerms"] == null)
                    ViewState["SearchTerms"] = string.Format(" Where state={0} and  TransferState={1}", (int)Status.CunDang,(int)TransferState.CunDang);
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                sb.AppendFormat(" AND State != {0} ", (int)Status.Normal);
            }
