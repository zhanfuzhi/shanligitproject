...
namespace Shanlitech_Location.Web.Module.Shanlitech_Location.T_BudgetDetail
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string BudgetNumber_Value = (string)Common.sink(BudgetNumber_Input.UniqueID, MethodType.Post, 10, 0, DataType.Str);
...
if (Measurement_Value != string.Empty)
{
    sb.AppendFormat(" AND Measurement like '%{0}%' ", Common.inSQL(Measurement_Value));
}
                    
                    
if (BudgetNumber_Value != string.Empty)
{
    sb.AppendFormat(" AND BudgetNumber = {0} ", Convert.ToInt32(BudgetNumber_Value));
}
...
{
    sb.AppendFormat(" AND Supplier like '%{0}%' ", Common.inSQL(Supplier_Value));
}
