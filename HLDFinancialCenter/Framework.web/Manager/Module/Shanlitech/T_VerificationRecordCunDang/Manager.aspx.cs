...
namespace Shanlitech_Location.Web.Module.Shanlitech_Location.T_VerificationRecordCunDang
{
    public partial class Manager : System.Web.UI.Page
    {
        ...
        private void OnStart()
        {
            ...
            { 
                case "New":
                    TabOptionItem1.Tab_Name = HeadMenuWebControls1.HeadOPTxt = "增加核销待存档单";
                    Hidden_Disp();
                    break;
                case "List":
                    TabOptionItem1.Tab_Name = HeadMenuWebControls1.HeadOPTxt = "查看核销待存档单";
                    Hidden_Input();
                    ButtonOption.Visible = false;
                    AddEditButton();
                    break;
                case "Edit":
                    TabOptionItem1.Tab_Name = HeadMenuWebControls1.HeadOPTxt = "修改核销待存档单";
                    Hidden_Disp();
                    AddDeleteButton();
                    break;
                case "Delete":
        ...
        private void OnStartData(T_VerificationRecordEntity ut)
        {
            ...
            CunDangState_Disp.Text = ut.CunDangNote;
        ...
        //PayAmount_Input.Visible = false;
            CunDangState_Input.Visible = false;
        ...
        //ContractFolder_Disp.Visible = false;
        //PayAmount_Disp.Visible = false;
            CunDangState_Disp.Visible = false;
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string newFile = "/Down/" + DateTime.Now.ToString("yyyyMMddHH");
            ...
            int TransferState_Value = (int)TransferState.CunDang;
                //(int)Common.sink(CheckState_Input.UniqueID, MethodType.Post, 10, 0, DataType.Int);
            int state = (int)Status.CunDang;
            //if (TransferState_Value.Equals(1))
            //{
            //    TransferState_Value = (int)TransferState.CunDang;
            //    state = (int)Status.CunDang;
            //}
            //else
            //{
            //    TransferState_Value = (int)TransferState.CunDang;
            ...
            string CunDangState = (string)Common.sink(CunDangState_Input.UniqueID, MethodType.Post, 500, 0, DataType.Str);
            ut.State = state;
            ut.TransferState = TransferState_Value;
            ut.ShenHeNote = CunDangState;
