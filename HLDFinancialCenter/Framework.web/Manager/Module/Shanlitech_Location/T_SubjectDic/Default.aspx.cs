...
{
    sb.AppendFormat(" AND SubjectNO like '%{0}%' ", Common.inSQL(SubjectNO_Value));
}
                    
if (SubjectName_Value != string.Empty)
{
    sb.AppendFormat(" AND SubjectName like '%{0}%' ", Common.inSQL(SubjectName_Value));
}
    ...
    sb.AppendFormat(" AND Sort = {0} ", Convert.ToInt32(Sort_Value));
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < Checkbox_Value_Array.Length; i++)
            {
                ...
                {
                    T_SubjectDicEntity et = new T_SubjectDicEntity();
