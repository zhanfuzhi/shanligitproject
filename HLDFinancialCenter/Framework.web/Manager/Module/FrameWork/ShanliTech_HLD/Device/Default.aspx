<%@ Page Language="C#" MasterPageFile="~/Manager/MasterPage/PageTemplate.Master" AutoEventWireup="True"
    Codebehind="Default.aspx.cs" Inherits="ShanliTech_HLD_Business.Web.Module.ShanliTech_HLD_Business.Device.Default"
    Title="无标题页" %>
...
.td_input
{
    ...
    <FrameWorkWebControls:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadHelpTxt="<a target='_blank' href='../../../Help/HelperDocument/DeviceDetectApp-InfoSecurity/DeviceManagerHelp.aspx'>帮助</a>"
         HeadOPTxt="设备列表" HeadTitleTxt="设备">
        ...
        <FrameWorkWebControls:TabOptionItem ID="TabOptionItem1" runat="server" Tab_Name="设备列表">
            <asp:GridView ID="GridView1" runat="server" OnSorting="GridView1_Sorting" OnRowCreated="GridView1_RowCreated" >
                <Columns>
                    ...
                    <asp:BoundField HeaderText="型号/规格" SortExpression="DeviceModel" DataField="DeviceModel" />
                    <asp:BoundField HeaderText="制造厂" SortExpression="DeviceFactory" DataField="DeviceFactory" />
                    <%--<asp:BoundField HeaderText="所属单位" SortExpression="DeviceDepartmentID" DataField="DeviceDepartmentID" />--%>
                    ...
                    <%--<asp:TemplateField HeaderText="检测方式">
                        <ItemTemplate>
                            <%#ShanliTech_HLD_Business.ToolMethods.GetDictionaryNameByID(Eval("DetectType").ToString())%>
                        </ItemTemplate>
                    </asp:TemplateField>--%>
                    ...
                    <asp:TemplateField HeaderText="操作" ItemStyle-HorizontalAlign="Left" ItemStyle-Wrap="false">
                        <ItemTemplate>
                            <a href="DefaultFunction.aspx?DeviceID=<%#Eval("ID")%>">查看设备功能</a>
                            <%--<a href="javascript:AssembleCmdPop(<%#Eval("ID") %>,'<%#Eval("DeviceModel") %>');">设备指令数据</a>
                            <a href="javascript:showPopWin('速成检定点','CreateDetectPoint.aspx?IDX=<%#Eval("ID")%>&rand'+rand(100000000),920, 480, AlertMessageBox,true)">速成检定点</a>--%>
