...
namespace Shanlitech_Location.Web.Module.Shanlitech_Location.T_FundsRecordShenHe
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        private string SearchTerms
        {
            get
            {
                if (ViewState["SearchTerms"] == null)
                    ViewState["SearchTerms"] = string.Format(" Where   TransferState={0} and state={1}",(int)TransferState.ShenHe,(int)Status.Normal);//经费使用申请单
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            sb.AppendFormat(" Where  TransferState={0}", (int)TransferState.ShenQing);
