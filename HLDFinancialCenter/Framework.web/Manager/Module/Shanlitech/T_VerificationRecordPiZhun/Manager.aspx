<%@ Page Language="C#" MasterPageFile="~/Manager/MasterPage/PageTemplate.Master" AutoEventWireup="True"
    Codebehind="Manager.aspx.cs" Inherits="Shanlitech_Location.Web.Module.Shanlitech_Location.T_VerificationRecordPiZhun.Manager"
    Title="无标题页" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="server">
    ...
    <FrameWorkWebControls:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server"  HeadTitleTxt="核销待批准单">
        <FrameWorkWebControls:HeadMenuButtonItem ButtonPopedom="List" ButtonUrl="Default.aspx"
            ButtonUrlType="Href" ButtonVisible="True" ButtonName="核销待批准单" />
    </FrameWorkWebControls:HeadMenuWebControls>
    <FrameWorkWebControls:TabOptionWebControls ID="TabOptionWebControls1" runat="server">
        <FrameWorkWebControls:TabOptionItem ID="TabOptionItem1" runat="server" Tab_Name="查看/修改/增加核销待批准单">
                 ...
                 <tr runat="server" id="tr">
                  ...
                  <tr runat="server" id="tr2">
                    ...
                    <td class="table_body">
                        是否通过</td>
                    <td class="table_none">
                        <asp:RadioButtonList runat="server" ID="CheckState_Input" RepeatDirection="Horizontal">
                  ...
                  <tr>
                    <td class="table_body">
                        批准原因</td>
                    <td class="table_none">
                    <asp:TextBox ID="PiZhunState_Input" title="请输入批准原因~500:" runat="server"></asp:TextBox>                    
