...
namespace Shanlitech_Location.Web.Module.Shanlitech_Location.T_VerificationRecord
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        {
            string FundID_Value = (string)Common.sink(FundID_Input.UniqueID, MethodType.Post, 10, 0, DataType.Str);
...
if (InvoiceFolder_Value != string.Empty)
{
    sb.AppendFormat(" AND InvoiceFolder like '%{0}%' ", Common.inSQL(InvoiceFolder_Value));
}
                    
if (ContractFolder_Value != string.Empty)
{
    sb.AppendFormat(" AND ContractFolder like '%{0}%' ", Common.inSQL(ContractFolder_Value));
}
