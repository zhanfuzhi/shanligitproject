...
namespace Shanlitech_Location.Web.Module.Shanlitech_Location.T_ClassDic
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        private void BindDataList()
        {
            ...
            int RecordCount = 0;
            List<T_ClassDicEntity> lst = BusinessFacadeShanlitech_Location.T_ClassDicList(qp, out RecordCount);
...
if (ClassName_Value != string.Empty)
{
    sb.AppendFormat(" AND ClassName like '%{0}%' ", Common.inSQL(ClassName_Value));
}
                    
if (ParentClassNO_Value != string.Empty)
{
    sb.AppendFormat(" AND ParentClassNO like '%{0}%' ", Common.inSQL(ParentClassNO_Value));
}
