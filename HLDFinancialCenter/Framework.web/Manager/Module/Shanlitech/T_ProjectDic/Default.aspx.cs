...
namespace Shanlitech_Location.Web.Module.Shanlitech_Location.T_ProjectDic
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                sb.AppendFormat(" AND ProjectNO like '%{0}%' ", Common.inSQL(ProjectNO_Value.Trim()));
            }
                    
if (ProjectName_Value != string.Empty)
{
    sb.AppendFormat(" AND ProjectName like '%{0}%' ", Common.inSQL(ProjectName_Value.Trim()));
}
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < Checkbox_Value_Array.Length; i++)
            {
                ...
                {
                    T_ProjectDicEntity et = BusinessFacadeShanlitech_Location.T_ProjectDicDisp(IDX);
