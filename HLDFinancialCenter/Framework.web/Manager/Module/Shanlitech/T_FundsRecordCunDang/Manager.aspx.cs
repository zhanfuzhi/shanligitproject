...
namespace Shanlitech_Location.Web.Module.Shanlitech_Location.T_FundsRecordCunDang
{
    public partial class Manager : System.Web.UI.Page
    {
        ...
        private void OnStart()
        {
            ...
            { 
                case "New":
                    TabOptionItem1.Tab_Name = HeadMenuWebControls1.HeadOPTxt = "增加经费使用待存档";
                    Hidden_Disp();
                    break;
                case "List":
                    TabOptionItem1.Tab_Name = HeadMenuWebControls1.HeadOPTxt = "查看经费使用待存档";
                    Hidden_Input();
                    ButtonOption.Visible = false;
                    AddEditButton();
                    break;
                case "Edit":
                    TabOptionItem1.Tab_Name = HeadMenuWebControls1.HeadOPTxt = "修改经费使用待存档";
                    Hidden_Disp();
                    AddDeleteButton();
                    break;
                case "Delete":
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            //{
            int State_Value = (int)Status.CunDang;
            ...
            if (rInt > 0)
            {
                string OpTxt = string.Format("增加经费使用存档申请单成功!(ID:{0})", rInt);
                if (ut.DataTable_Action_ == DataTable_Action.Update)
                    OpTxt = string.Format("修改经费使用存档单成功!(ID:{0})", IDX);
