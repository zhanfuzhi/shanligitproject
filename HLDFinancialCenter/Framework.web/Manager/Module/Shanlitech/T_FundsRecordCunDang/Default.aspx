<%@ Page Language="C#" MasterPageFile="~/Manager/MasterPage/PageTemplate.Master" AutoEventWireup="True"
    Codebehind="Default.aspx.cs" Inherits="Shanlitech_Location.Web.Module.Shanlitech_Location.T_FundsRecordCunDang.Default"
    Title="无标题页" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="server">
    ...
    <FrameWorkWebControls:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server"
         HeadOPTxt="经费使用待存档单列表" HeadTitleTxt="经费使用待存档">
        <FrameWorkWebControls:HeadMenuButtonItem ButtonPopedom="New" ButtonUrl="Manager.aspx?CMD=New"
            ButtonUrlType="Href" ButtonVisible="false" ButtonName="经费使用待存档" />
    </FrameWorkWebControls:HeadMenuWebControls>
    <FrameWorkWebControls:TabOptionWebControls ID="TabOptionWebControls1" runat="server">
        <FrameWorkWebControls:TabOptionItem ID="TabOptionItem1" runat="server" Tab_Name="经费使用待存档列表">
            <asp:GridView ID="GridView1" runat="server" OnSorting="GridView1_Sorting" 
                ...
                <Columns>
                 ...
                 <%--     <asp:TemplateField HeaderText="其它操作">
                        <ItemTemplate>
                           <asp:LinkButton ID="LinkButton1" runat="server" CommandName="CunDang" CommandArgument='<%# Eval("ID") %>'
                                OnClientClick='javascript:return confirm("确定要存档吗？");' Text="存档">
                            </asp:LinkButton>
                            <asp:LinkButton ID="LinkButton2" runat="server" CommandName="QXCunDang" CommandArgument='<%# Eval("ID") %>'
                                OnClientClick='javascript:return confirm("确定要撤回批准吗？");' Text="撤回批准">
                            </asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>--%>
                  </Columns>
