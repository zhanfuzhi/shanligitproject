<%@ Page Language="C#" MasterPageFile="~/Manager/MasterPage/PageTemplate.Master" AutoEventWireup="True"
    Codebehind="ManagerFunction.aspx.cs" Inherits="ShanliTech_HLD_Business.Web.Module.ShanliTech_HLD_Business.DeviceTemplate.ManagerFunction"
    Title="无标题页" %>

<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="server">
    <FrameWorkWebControls:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadHelpTxt="<a target='_blank' href='../../../Help/HelperDocument/DeviceDetectApp-InfoSecurity/DeviceFunctionTemplateHelp.aspx#p5'>帮助</a>" HeadTitleTxt="设备功能模板">
        <%--<FrameWorkWebControls:HeadMenuButtonItem ButtonPopedom="List" ButtonUrl="Default.aspx"
            ButtonUrlType="Href" ButtonVisible="True" ButtonName="设备功能模板" />--%>
    </FrameWorkWebControls:HeadMenuWebControls>
    <FrameWorkWebControls:TabOptionWebControls ID="TabOptionWebControls1" runat="server">
        <FrameWorkWebControls:TabOptionItem ID="TabOptionItem1" runat="server" Tab_Name="查看/修改/增加设备功能模板">
            <table width="100%" border="0" cellspacing="1" cellpadding="3" align="center">

                <tr>
                    <td class="table_body">
                        设备模板编号（Serials No.）</td>
                    <td class="table_none">
                        <%--<asp:DropDownList ID="DeviceID_DropDown" runat="server" ></asp:DropDownList>--%>
                        <%--<asp:TextBox ID="DeviceID_Input" Enabled="false" title="请输入设备模板编号~2147483648:int" runat="server" CssClass="text_input"></asp:TextBox>
                    --%>
...
function ClearTime(){
    document.getElementById("<%=SourceValidDate_Input.ClientID %>").value="";
