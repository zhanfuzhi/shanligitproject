...
namespace Shanlitech_Location.Web.Module.Shanlitech_Location.T_BudgetDetail
{
    public partial class Manager : System.Web.UI.Page
    {
        ...
        private void Hidden_Disp()
        {
            ...
            tr_BudgetExpenditure.Visible = false;
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            double BudgetExpenditure_Value = (double)BudgetPrice_Value * BudgetNumber_Value;
                //(double)Common.sink(BudgetExpenditure_Input.UniqueID, MethodType.Post, 53, 0, DataType.Double);
