<%@ Page Language="C#" MasterPageFile="~/Manager/MasterPage/PageTemplate.Master" AutoEventWireup="True"
    Codebehind="DefaultApprove.aspx.cs" Inherits="ShanliTech_HLD_Business.Web.Module.ShanliTech_HLD_Business.DetectApprove.DefaultApprove"
    Title="无标题页" %>
...
.td_input
{
    ...
    <FrameWorkWebControls:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadHelpTxt="<a target='_blank' href='../../../Help/HelperDocument/DeviceDetectApp-InfoSecurity/DeviceDetectHelp.aspx#p11'>帮助</a>"
         HeadOPTxt="检定批准列表" HeadTitleTxt="检定批准">
    ...
    <FrameWorkWebControls:TabOptionWebControls ID="TabOptionWebControls1" runat="server">
        <FrameWorkWebControls:TabOptionItem ID="TabOptionItem1" runat="server" Tab_Name="检定批准列表">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="操作">
                        <ItemTemplate>
                            ...
                            <a href="Doc_Online_Approve.aspx?CMD=ViewDoc&ReportPath=<%#Eval("ReportPath") %>">查看证书</a>
                        </ItemTemplate>
                    </asp:TemplateField>
