...
namespace Shanlitech_Location.Web.Module.Shanlitech_Location.T_ProjectDic
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        private void BindDataList()
        {
            ...
            int RecordCount = 0;
            List<T_ProjectDicEntity> lst = BusinessFacadeShanlitech_Location.T_ProjectDicList(qp, out RecordCount);
...
if (ProjectName_Value != string.Empty)
{
    sb.AppendFormat(" AND ProjectName like '%{0}%' ", Common.inSQL(ProjectName_Value));
}
    ...
    sb.AppendFormat(" AND State = {0} ", Convert.ToInt32(State_Value));
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < Checkbox_Value_Array.Length; i++)
            {
                ...
                {
                    T_ProjectDicEntity et = new T_ProjectDicEntity();
                    et.DataTable_Action_ = DataTable_Action.Delete;
                    et.ID = IDX;
                    BusinessFacadeShanlitech_Location.T_ProjectDicInsertUpdateDelete(et);
                }
            }
